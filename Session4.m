%% NNESMO: Session 4 - Approximate methods for differentiation and integration
%
% Dr Simon A Mathias
%
...
% Durham University
%
%% This session's leaning objectives
%
...
%
% The main focus of this course is to develop
% numerical models of various earth processes. Generally, these models
% involve the numerical solution of sets of partial differential
% equations. You will learn more about these in subsequent lectures. In
% this lecture we will look at the more fundamental process of approximating 
% derivatives and integrals  using finite differences and trapezoidal 
...
%Plot results
figure(1)
hold off %Destroy previous plots in figure(1)
...
% when $x = 0$.
%
% Write further script to plot your results appropriately on a single
