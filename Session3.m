%% NNESMO: Session 3 - Using subfunctions
%
% Dr Simon A Mathias
%
...
%%
% Save the file as  |DurhamWeatherStatistics.m| in the |NNESMOmfiles| directory. Then run (by pressing 
