%% NNESMO: Session 5 - MATLAB's ODE solvers
%
% Dr Simon A Mathias
%
...
% condition, y0, by first-order explicit time-stepping. Read the help file about
% the command |feval|. This command is useful if you do not already know the
% name of the function to be used. The function name is specified through
% the string, |odefun|. All the subsequent parameters in the |feval| input
% argument are carried forward to the function specified by |odefun|, which
...
%   [t,C]=MYsolver(@MYodefun,t,C0,lambda);
%
% Where it says |@MYodefun|, we are essentially telling MYsolver that 
% |odefun='MYodefun'|. Using the @ sign like this is a little bit like
% telling MATLAB that the characters following the @ sign are strings.
% 
...
%
% Read the help file about |ode45|. Now modify your |ZeroDimExR2.m| script such that 
