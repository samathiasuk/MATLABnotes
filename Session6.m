%% NNESMO: Session 6 - Solving PDEs using ODE solvers
%
% Dr Simon A Mathias
%
...
% characterised by a transmissivity of 800 $\mathrm{m}^{2}/\mathrm{day}$
...
% a subfunction underneath the main function.
%
...
% nearby river. Creat a new script-file called |ADEproblem.m| and use the advection dispersion equation to simulate the 
...
% C_{dump}, & 0\leq t\leq t_{dump}\\
% \\
% C_I, & t>t_{dump}
% \end{array}\right.$$
%
% where $C_{dump}=120$ mg/l and $t_{dump}=1$ day.
%
...
% dispersion coefficient by a factor of 20. What happens? You will learn
% more about this problem later in the week.
