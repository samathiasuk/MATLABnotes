%% NNESMO: Session 1 - Arrays and plotting
%
% Dr Simon A Mathias
%
...
%%
%
% Create a directory (folder) called "NNESMOmfiles" in an appropriate place.
% Click on "File", "Save As...", browse to "NNESMOmfiles" 
% and save the file as "MyFirstScriptFile.m".
%
...
%
% Note that the first line, |function MyFirstScriptFile|, starts the script
% file and tells MATLAB what it is called. All those lines with |%| at the
% beginning do nothing. They are "comments". It is very important to write
...
%
% Save <https://www.dur.ac.uk/s.a.mathias/NNESMO/DurhamWeather.xlsx DurhamWeather.xlsx> to the directory, "NNESMOmfiles". To read
% the spreadsheet data into a 2D array called |data| add the following text
% to your mfile, "MyFirstScriptFile.m".
 
%Import Durham weather data from excel
data=xlsread('DurhamWeather.xlsx','Sheet1');
 
%%
% |xlsread| is a MATLAB function that reads Excel files. Note that we are 
% going to store the data in the array, |data|. The two function "arguments" for
% xlsread are the file name, |DurhamWeather.xlsx|, and the sheet name,
% |Sheet1| (note that many spreadsheet files contain more than one sheet).
% We need to type these names in between single quotes, i.e., the |' '|.
...
% |xlsread| function ignores the header information and stores all the
...
% <https://www.dur.ac.uk/s.a.mathias/NNESMO/NorthSeaRocks.xlsx
...
% out more. Study xlsread in help as well to find out how to import more 
% than one worksheet.
